...
import {
  subscribeCart, addToCart, decrementCart, removeFromCart,
                  ...
                  <div className="p-5 border-t border-white/10 shrink-0">
                    ...
                    <div className="mb-4">
                      <div className="h-1.5 bg-white/5 rounded-full overflow-hidden mb-1.5">
                       ...
                       <p className="text-[10px] font-black uppercase tracking-widest text-center text-[#4ade80]">
                         Shopping list ready — visit a store to purchase
                      </p>
                    </div>
                    ...
                    <button
                       ...
                       className="w-full py-4 font-black uppercase tracking-widest text-sm transition-colors active:scale-[0.98]"
              ...
              <>
                <div className="flex-1 overflow-y-auto p-5 space-y-5">
                  ...
                  <p className="text-[10px] text-white/25 uppercase tracking-widest font-bold text-center leading-relaxed">
                     This shopping list is for in-store purchasing.<br />We do not take remote orders or payments.
                  </p>
                </div>
                ...
                <div className="p-5 border-t border-white/10 shrink-0">
                   <a
                     href="/store-locator"
                     onClick={onClose}
                     className="w-full py-4 bg-[#22C55E] text-black font-black uppercase tracking-widest text-sm hover:brightness-110 transition-all active:scale-[0.98] flex items-center justify-center gap-2"
                  >
