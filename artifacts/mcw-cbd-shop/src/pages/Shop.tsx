...
const CATEGORY_COLORS: Record<Category, string> = {
  ...
  Vaporisers:  "#94a3b8",
  Seeds:       "#84cc16",
  "Nicotine Vapes": "#f59e0b",
  "Nicotine E-Liquids": "#14b8a6",
};
        ...
        <div className="absolute inset-0 [backface-visibility:hidden] [transform:rotateY(180deg)] overflow-hidden" style={{ backgroundColor: '#071a09' }}>
          ...
          <div className="absolute inset-0 flex flex-col justify-between p-5 pt-6">
            ...
            <div>
              ...
              <p className="text-[9px] font-black uppercase tracking-widest text-white/30 mb-4">incl. VAT · Purchase in store</p>
              <button
  ...
  return (
    <>
      <SEO
        ...
        description="Malta's #1 Hemp & CBD Destination. Real products, real photos. Browse online, then purchase in store."
      />
      ...
      <div className="pt-32 pb-10 bg-[#0a0a0a] border-b border-white/10 relative overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <p className="text-white/30 font-black tracking-widest uppercase text-sm mb-8">
            93 Products · 10 Categories · Malta's Best
          </p>
      ...
      <div className="bg-[#111] border-b border-white/5 py-2.5 px-4">
        <div className="max-w-[1400px] mx-auto flex flex-wrap items-center justify-center gap-x-6 gap-y-1 text-center">
          <span className="text-[10px] font-black uppercase tracking-widest text-white/50">📍 Purchase in store only</span>
