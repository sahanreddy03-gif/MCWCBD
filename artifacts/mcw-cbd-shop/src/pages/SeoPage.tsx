            ...
            <div className="space-y-4">
              ...
              >
                ...
                <p className="text-gray-400 text-sm mb-5 leading-relaxed">
                  Browse the range online, then visit one of our 4 Malta stores to purchase in person. Work time -12:00 - 22:00.
                </p>
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-4">
              {MCW_STORES.map((store) => (
                ...
                >
                  ...
                  <p className="text-green-500 text-xs mt-1">Work time -12:00 - 22:00</p>
