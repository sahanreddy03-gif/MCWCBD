...
export default function Brands() {
  return (
    <>
      <SEO title="Premium CBD Brands in Malta — MCW Shop" description="Shop Malta's best CBD brands at MCW — Jeeter, Canapuff, Cookies, Tyson 2.0, H4CBD, THCV and more. 4 stores across Malta — visit us in store." />
      ...
      <div className="pt-16 pb-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-32 p-12 bg-primary/10 border border-primary/20 rounded-3xl text-center">
          ...
          <a href="/store-locator" className="inline-block px-8 py-4 bg-primary text-primary-foreground font-bold uppercase tracking-widest rounded-xl hover:bg-primary/90 transition-colors">
            Visit a Store
          </a>
        </div>
      </div>
