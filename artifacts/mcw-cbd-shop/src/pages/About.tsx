...
const FAQS = [
  ...
  { q: "Do you deliver?", a: "No, we don't offer delivery — all purchases are made in store. Visit any of our 4 stores (Valletta, Sliema, Mellieha, Bugibba); daily hours are 12:00–22:00." },
...
export default function About() {
  ...
  return (
    <>
      <SEO title="About MCW — Malta's #1 CBD Shop" description="Learn about MCW CBD Relax Shop — Malta's leading hemp and CBD retailer with 4 stores in Sliema, Mellieha, Bugibba, and Valletta. Premium products, expert staff, lab-tested quality." />
