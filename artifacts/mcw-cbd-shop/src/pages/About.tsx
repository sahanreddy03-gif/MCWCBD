...
const FAQS = [
  ...
  { q: "Do you deliver?", a: "No, we don't offer delivery — all purchases are made in store. Visit any of our 4 stores (Valletta, Sliema, Mellieha, Bugibba). Work time -12:00 - 22:00." },
