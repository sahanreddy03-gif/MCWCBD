...
const FAQS = [
  ...
  { q: "Do you deliver?", a: "No, we don't offer delivery — all purchases are made in store. Visit any of our 4 stores (Valletta, Sliema, Mellieha, Bugibba), open daily until 11:30 pm." },
