...
export default function CBDFlowerInMellieha() {
      ...
      <div className="relative pt-20 pb-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-8 flex items-center gap-2 text-sm text-gray-400">
            ...
            <span>/</span>
            <span className="text-green-400">CBD Flower in Mellieha</span>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div>
                ...
                <h1 className="text-6xl font-black bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-emerald-400 to-teal-400 mb-6 leading-tight">
                  CBD Flower in Mellieha
                </h1>
                <p className="text-xl text-gray-300 leading-relaxed max-w-xl">
                  Experience premium quality cbd flower crafted for discerning customers in Mellieha. 
            ...
            <div className="relative h-96 rounded-2xl overflow-hidden bg-gradient-to-br from-green-900/20 to-slate-900/20 border border-green-500/20 backdrop-blur flex items-center justify-center">
              ...
              <div className="relative z-10 text-center">
                ...
                <p className="text-gray-300 font-semibold">CBD Flower</p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-300 mb-8 leading-relaxed">
                Experience our premium cbd flower selection in person. Our knowledgeable team is ready to assist you.
              </p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm leading-relaxed">
                  All MCW cbd flower products contain less than 0.2% THC and are fully legal in Malta. 
