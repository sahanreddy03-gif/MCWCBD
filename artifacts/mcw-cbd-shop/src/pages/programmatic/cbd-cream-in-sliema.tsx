...
export default function CBDCreamInSliema() {
      ...
      <div className="relative pt-20 pb-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-8 flex items-center gap-2 text-sm text-gray-400">
            ...
            <span>/</span>
            <span className="text-green-400">CBD Cream in Sliema</span>
          </div>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-xl text-gray-300 leading-relaxed max-w-xl">
                  Experience premium quality cbd cream crafted for discerning customers in Sliema. 
