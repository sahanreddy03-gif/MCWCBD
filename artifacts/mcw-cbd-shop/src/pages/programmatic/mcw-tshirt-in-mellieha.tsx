...
export default function McwTshirtInMellieha() {
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="bg-gradient-to-b from-green-900 to-black py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl font-bold mb-4">Premium MCW T-Shirt in Mellieha</h1>
          <p className="text-xl text-gray-300">
            Buy high-quality MCW T-Shirt in Mellieha, Malta. Legal, lab-tested, <0.2% THC.
          </p>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <div className="bg-gray-900 rounded-lg p-8 border border-green-500 mb-8">
              <h2 className="text-3xl font-bold text-green-400 mb-4">MCW T-Shirt in Mellieha</h2>
              <p className="text-gray-300 mb-6">
                Premium MCW T-Shirt available in Mellieha. Our MCW T-Shirt is sourced from the finest EU hemp and tested for quality, purity, and potency.
              </p>
              ...
              <div className="bg-green-900 p-4 rounded-lg mb-8">
                ...
                <p className="text-sm text-gray-300 mt-2">
                  All MCW T-Shirt products contain less than 0.2% THC and are fully legal in Malta. For adults 18+ only. Not intended to diagnose, treat, cure, or prevent disease.
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            <div className="bg-gray-900 rounded-lg p-8 border border-green-500 mb-8">
              ...
              <div className="space-y-3">
                ...
                >
                  Order MCW T-Shirt via WhatsApp
                </a>
              </div>
            </div>
          </div>
