import { MapPin, ShoppingCart, CheckCircle, Star, Truck, Lock } from 'lucide-react';
import { useState } from 'react';

export default function RollingPapersInMellieha() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-black to-slate-900 text-white overflow-hidden">
      ...
      <div className="relative pt-20 pb-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-8 flex items-center gap-2 text-sm text-gray-400">
            ...
            <span>/</span>
            <span className="text-green-400">Rolling Papers in Mellieha</span>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div>
                ...
                <h1 className="text-6xl font-black bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-emerald-400 to-teal-400 mb-6 leading-tight">
                  Rolling Papers in Mellieha
                </h1>
                <p className="text-xl text-gray-300 leading-relaxed max-w-xl">
                  Experience premium quality rolling papers crafted for discerning customers in Mellieha. 
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="bg-slate-800/50 backdrop-blur border border-slate-700 rounded-lg p-4 text-center hover:border-green-500/50 transition">
                  ...
                  <p className="text-sm text-gray-300">In-Store Purchase</p>
                </div>
              </div>
            ...
            <div className="relative h-96 rounded-2xl overflow-hidden bg-gradient-to-br from-green-900/20 to-slate-900/20 border border-green-500/20 backdrop-blur flex items-center justify-center">
              ...
              <div className="relative z-10 text-center">
                ...
                <p className="text-gray-300 font-semibold">Rolling Papers</p>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              { icon: '⚡', title: 'In-Store Purchase', desc: 'Purchase at our Mellieha store' },
      ...
      <div className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold mb-6 text-white">Visit Us in Mellieha</h2>
              <p className="text-gray-300 mb-8 leading-relaxed">
                Experience our premium rolling papers selection in person. Our knowledgeable team is ready to assist you.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4 p-4 bg-slate-800/30 backdrop-blur border border-slate-700/50 rounded-lg hover:border-green-500/50 transition">
                  ...
                  <div>
                    <p className="font-bold text-white">MCW CBD Shop - Mellieha</p>
            ...
            <div className="relative h-96 rounded-2xl overflow-hidden bg-gradient-to-br from-green-900/20 to-slate-900/20 border border-green-500/20 backdrop-blur flex items-center justify-center">
              ...
              <div className="relative z-10 text-center">
                ...
                <p className="text-gray-300 font-semibold">Mellieha, Malta</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm leading-relaxed">
                  All MCW rolling papers products contain less than 0.2% THC and are fully legal in Malta. 
