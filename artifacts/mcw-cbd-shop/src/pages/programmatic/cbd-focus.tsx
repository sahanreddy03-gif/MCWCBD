...
export default function CBDFocus() {
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="bg-gradient-to-b from-green-900 to-black py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl font-bold mb-4">Focus with CBD</h1>
          <p className="text-xl text-gray-300">Discover how CBD can help with focus</p>
        </div>
      </div>

      <div className="max-w-4xl mx-auto px-4 py-16">
        <div className="bg-gray-900 rounded-lg p-8 border border-green-500 mb-8">
          <h2 className="text-3xl font-bold text-green-400 mb-6">How CBD Helps with Focus</h2>
          <p className="text-gray-300 mb-6">
            CBD (Cannabidiol) has been studied for its potential benefits in supporting focus. 
        ...
        <div className="bg-gray-900 rounded-lg p-8 border border-green-500">
          ...
          <p className="text-gray-300 mb-6">
            Explore our range of premium CBD products that users find helpful for focus:
          </p>
