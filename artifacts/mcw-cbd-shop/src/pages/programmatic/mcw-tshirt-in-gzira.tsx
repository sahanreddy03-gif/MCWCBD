...
export default function McwTshirtInGzira() {
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="bg-gradient-to-b from-green-900 to-black py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl font-bold mb-4">Premium MCW T-Shirt in Gzira</h1>
          <p className="text-xl text-gray-300">
            Buy high-quality MCW T-Shirt in Gzira, Malta. Legal, lab-tested, <0.2% THC.
          </p>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <div className="bg-gray-900 rounded-lg p-8 border border-green-500 mb-8">
              <h2 className="text-3xl font-bold text-green-400 mb-4">MCW T-Shirt in Gzira</h2>
              <p className="text-gray-300 mb-6">
                Premium MCW T-Shirt available in Gzira. Our MCW T-Shirt is sourced from the finest EU hemp and tested for quality, purity, and potency.
              </p>
