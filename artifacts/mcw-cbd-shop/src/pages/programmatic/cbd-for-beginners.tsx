...
export default function CbdForBeginners() {
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="bg-gradient-to-b from-green-900 to-black py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl font-bold mb-4">CBD for Beginners</h1>
          <p className="text-xl text-gray-300">Complete guide to cbd for beginners</p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        <div className="bg-gray-900 rounded-lg p-8 border border-green-500 mb-8">
          <div className="flex items-start mb-6">
            ...
            <div>
              <h2 className="text-3xl font-bold text-green-400 mb-4">CBD for Beginners</h2>
              <p className="text-gray-300 mb-6">
                This comprehensive guide covers everything you need to know about cbd for beginners. 
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-start">
                  ...
                  <p className="text-gray-300">Understanding the basics of cbd for beginners</p>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="w-5 h-5 text-green-400 mr-3 mt-1 flex-shrink-0" />
