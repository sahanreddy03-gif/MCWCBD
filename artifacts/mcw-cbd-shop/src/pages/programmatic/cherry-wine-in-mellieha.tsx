    ...
    <div className="min-h-screen bg-black text-white">
      <div className="bg-gradient-to-b from-green-900 to-black py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl font-bold mb-4">Premium Cherry Wine in Mellieha</h1>
          <p className="text-xl text-gray-300">
            Buy high-quality Cherry Wine in Mellieha, Malta. Legal, lab-tested, <0.2% THC.
          </p>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <div className="bg-gray-900 rounded-lg p-8 border border-green-500 mb-8">
              <h2 className="text-3xl font-bold text-green-400 mb-4">Cherry Wine in Mellieha</h2>
              <p className="text-gray-300 mb-6">
                Premium Cherry Wine available in Mellieha. Our Cherry Wine is sourced from the finest EU hemp and tested for quality, purity, and potency.
              </p>
              ...
              <div className="space-y-3 mb-8">
                ...
                <div className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-400 mr-3" />
                  <span>Fast delivery in Mellieha</span>
                </div>
              </div>
              ...
              <div className="bg-green-900 p-4 rounded-lg mb-8">
                ...
                <p className="text-sm text-gray-300 mt-2">
                  All Cherry Wine products contain less than 0.2% THC and are fully legal in Malta. For adults 18+ only. Not intended to diagnose, treat, cure, or prevent disease.
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            <div className="bg-gray-900 rounded-lg p-8 border border-green-500 mb-8">
              <h3 className="text-2xl font-bold text-green-400 mb-6">Visit Us in Mellieha</h3>
              
              <div className="space-y-4 mb-8">
                <div className="flex items-start">
                  <MapPin className="w-5 h-5 text-green-400 mr-3 mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-bold">MCW CBD Shop - Mellieha</p>
              ...
              <div className="space-y-3">
                <a
                  href="https://wa.me/35699536248?text=Hi%20MCW%2C%20I%27m%20interested%20in%20Cherry Wine"
                  target="_blank"
