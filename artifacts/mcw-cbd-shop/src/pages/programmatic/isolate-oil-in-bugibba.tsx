...
export default function IsolateOilInBugibba() {
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="bg-gradient-to-b from-green-900 to-black py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl font-bold mb-4">Premium Isolate Oil in Bugibba</h1>
          <p className="text-xl text-gray-300">Buy high-quality Isolate Oil in Bugibba, Malta. Legal, lab-tested, <0.2% THC.</p>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <div className="bg-gray-900 rounded-lg p-8 border border-green-500 mb-8">
              <h2 className="text-3xl font-bold text-green-400 mb-4">Isolate Oil</h2>
              <p className="text-gray-300 mb-6">Premium Isolate Oil available in Bugibba. Lab tested and verified.</p>
