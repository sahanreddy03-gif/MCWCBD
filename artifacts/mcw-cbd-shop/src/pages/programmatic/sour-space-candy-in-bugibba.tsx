...
export default function SourSpaceCandyInBugibba() {
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="bg-gradient-to-b from-green-900 to-black py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl font-bold mb-4">Premium Sour Space Candy in Bugibba</h1>
          <p className="text-xl text-gray-300">Buy high-quality Sour Space Candy in Bugibba, Malta. Legal, lab-tested, <0.2% THC.</p>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <div className="bg-gray-900 rounded-lg p-8 border border-green-500 mb-8">
              <h2 className="text-3xl font-bold text-green-400 mb-4">Sour Space Candy</h2>
              <p className="text-gray-300 mb-6">Premium Sour Space Candy available in Bugibba. Lab tested and verified.</p>
          ...
          <div>
            <div className="bg-gray-900 rounded-lg p-8 border border-green-500 mb-8">
              <h3 className="text-2xl font-bold text-green-400 mb-6">Visit Us in Bugibba</h3>
              <div className="space-y-4 mb-8">
                <div className="flex items-start">
                  <MapPin className="w-5 h-5 text-green-400 mr-3 mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-bold">MCW CBD Shop - Bugibba</p>
