...
export default function VapeCartridgeInValletta() {
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="bg-gradient-to-b from-green-900 to-black py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl font-bold mb-4">Premium Vape Cartridge in Valletta</h1>
          <p className="text-xl text-gray-300">Buy high-quality Vape Cartridge in Valletta, Malta. Legal, lab-tested, <0.2% THC.</p>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <div className="bg-gray-900 rounded-lg p-8 border border-green-500 mb-8">
              ...
              <p className="text-gray-300 mb-6">Premium Vape Cartridge available in Valletta. Lab tested and verified.</p>
