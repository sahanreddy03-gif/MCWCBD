...
export default function SourSpaceCandyInMellieha() {
  return (
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <div className="bg-gray-900 rounded-lg p-8 border border-green-500 mb-8">
              <h2 className="text-3xl font-bold text-green-400 mb-4">Sour Space Candy in Mellieha</h2>
              <p className="text-gray-300 mb-6">
                Premium Sour Space Candy available in Mellieha. Our Sour Space Candy is sourced from the finest EU hemp and tested for quality, purity, and potency.
              </p>
