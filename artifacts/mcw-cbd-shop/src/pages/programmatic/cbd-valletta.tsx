...
export default function CBDValletta() {
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="bg-gradient-to-b from-green-900 to-black py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl font-bold mb-4">CBD Products in Valletta, Malta</h1>
          <p className="text-xl text-gray-300">Premium quality CBD shop serving Valletta and surrounding areas</p>
        </div>
      </div>

      <div className="max-w-4xl mx-auto px-4 py-16">
        <div className="bg-gray-900 rounded-lg p-8 border border-green-500 mb-8">
          <h2 className="text-3xl font-bold text-green-400 mb-6">MCW CBD Shop in Valletta</h2>
          <p className="text-gray-300 mb-6">
            Welcome to MCW CBD Shop in Valletta! We offer a premium selection of legal CBD products including flowers, oils, vapes, and accessories. 
          ...
          <div className="space-y-4 mb-8">
            <div className="flex items-start">
              ...
              <div>
                <h3 className="font-bold text-green-300">Visit Us in Valletta</h3>
          ...
          >
            Order from Valletta via WhatsApp
          </a>
        </div>
        ...
        <div className="bg-gray-900 rounded-lg p-8 border border-green-500">
          ...
          <p className="text-gray-300 mb-6">
            We stock a wide variety of premium CBD products available for delivery in Valletta:
          </p>
