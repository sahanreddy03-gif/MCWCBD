...
export default function VapeCartridgevsSourSpaceCandy() {
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="bg-gradient-to-b from-green-900 to-black py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl font-bold mb-4">Vape Cartridge vs Sour Space Candy</h1>
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          <div className="bg-gray-900 rounded-lg p-8 border border-green-500">
            <h2 className="text-2xl font-bold text-green-400 mb-6">Vape Cartridge</h2>
          ...
          <div className="bg-gray-900 rounded-lg p-8 border border-green-500">
            <h2 className="text-2xl font-bold text-green-400 mb-6">Sour Space Candy</h2>
            <div className="space-y-3">
              <div className="flex items-start">
                <CheckCircle className="w-5 h-5 text-green-400 mr-3 mt-1 flex-shrink-0" />
                <p className="text-gray-300">Premium quality</p>
        ...
        <div className="bg-gray-900 rounded-lg p-8 border border-green-500">
          ...
          <p className="text-gray-300 mb-4">
            Both Vape Cartridge and Sour Space Candy are excellent choices from MCW CBD Shop. Your choice depends on your personal preferences and needs.
          </p>
