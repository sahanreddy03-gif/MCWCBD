...
export default function PremiumHashvsCBDCream() {
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="bg-gradient-to-b from-green-900 to-black py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl font-bold mb-4">Premium Hash vs CBD Cream</h1>
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          ...
          <div className="bg-gray-900 rounded-lg p-8 border border-green-500">
            <h2 className="text-2xl font-bold text-green-400 mb-6">CBD Cream</h2>
            <div className="space-y-3">
              <div className="flex items-start">
                <CheckCircle className="w-5 h-5 text-green-400 mr-3 mt-1 flex-shrink-0" />
                <p className="text-gray-300">Premium quality</p>
        ...
        <div className="bg-gray-900 rounded-lg p-8 border border-green-500">
          ...
          <p className="text-gray-300 mb-4">
            Both Premium Hash and CBD Cream are excellent choices from MCW CBD Shop. Your choice depends on your personal preferences and needs.
          </p>
