...
export default function Stores() {
  return (
    <>
      <SEO title="MCW CBD Shop Locations — Valletta, Sliema, Mellieha & Bugibba" description="Find MCW CBD Relax Shop near you. Four verified stores across Malta: Valletta (main branch), Sliema, Mellieha, and Bugibba. Work time -12:00 - 22:00. Visit us in store." />
