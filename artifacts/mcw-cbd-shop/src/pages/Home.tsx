      ...
      <section className="py-24 bg-[#0a0a0a]">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <a href="https://www.instagram.com/cbd_paterson/" target="_blank" rel="noreferrer" className="text-[#22c55e] font-black uppercase tracking-[0.3em] text-sm hover:text-white transition-colors">@cbd_paterson</a>
          </div>
          <div className="grid grid-cols-3 gap-2 md:gap-4">
            {[
              ...
              <a key={idx} href="https://www.instagram.com/cbd_paterson/" target="_blank" rel="noreferrer" className="relative aspect-square overflow-hidden group">
          ...
          <div className="text-center mt-10">
            <a href="https://www.instagram.com/cbd_paterson/" target="_blank" rel="noreferrer" className="inline-flex items-center gap-3 px-10 py-5 bg-white text-black font-black uppercase tracking-widest text-sm hover:bg-[#22c55e] hover:text-black transition-colors">
