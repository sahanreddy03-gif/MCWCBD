...
function buildLocationContent(product: string, location: string): { h1: string; intro: string; bodyParagraphs: string[] } {
  return {
    ...
    intro: `Looking for ${product} in ${location}? MCW CBD Relax Shop is ${location}'s #1 destination for premium CBD products. Work time -12:00 - 22:00, and we carry a full range of lab-tested CBD products including oils, flowers, vapes, gummies, and accessories.`,
    bodyParagraphs: [
      ...
      `Can't make it to our ${location} store right now? Browse the range online, then visit any of our four Malta stores to purchase in person. Our in-store team can answer product questions and offer expert advice.`,
...
function buildCityContent(city: string): { h1: string; intro: string; bodyParagraphs: string[] } {
  return {
    ...
    bodyParagraphs: [
      ...
      `MCW CBD Relax Shop serves ${city} with in-store shopping and a full range of products to browse online before your visit. Work time -12:00 - 22:00 so you can shop when it suits you.`,
...
function buildComparisonContent(label: string): { h1: string; intro: string; bodyParagraphs: string[] } {
  ...
  return {
    ...
    bodyParagraphs: [
      ...
      `Not sure which to choose? Visit any MCW CBD Relax Shop — our knowledgeable staff will help you find the right product for your needs and budget.`,
    ],
  };
}
...
function buildGuideContent(label: string): { h1: string; intro: string; bodyParagraphs: string[] } {
  return {
    ...
    bodyParagraphs: [
      ...
      `If you have specific questions about ${label.toLowerCase()}, ask our expert team in-store at any of four locations (Valletta, Sliema, Mellieha, Bugibba).`,
...
function buildEducationContent(label: string): { h1: string; intro: string; bodyParagraphs: string[] } {
  return {
    ...
    bodyParagraphs: [
      ...
      `Have more questions about ${label.toLowerCase()}? Visit any of our four MCW stores in Valletta, Sliema, Mellieha, or Bugibba for in-person guidance.`,
    ],
  };
}
...
function buildLifestyleContent(label: string): { h1: string; intro: string; bodyParagraphs: string[] } {
  return {
    ...
    bodyParagraphs: [
      ...
      `Ready to start your CBD lifestyle journey? Visit an MCW store in Valletta, Sliema, Mellieha, or Bugibba to browse and purchase in person.`,
    ],
  };
}
...
function buildAboutContent(label: string): { h1: string; intro: string; bodyParagraphs: string[] } {
  return {
    ...
    bodyParagraphs: [
      ...
      `Today, MCW operates four stores in Valletta, Sliema, Mellieha, and Bugibba — serving customers from all walks of life, from wellness enthusiasts to curious first-timers. Work time -12:00 - 22:00 at all stores.`,
...
function generatePageContent(slug: string, label: string, cat: string): {
  ...
  if (cat === "Location") {
    ...
    if (parsed) {
      ...
      return {
        ...
        metaDescription: `Buy ${product} in ${location}, Malta at MCW CBD Relax Shop. Premium quality, lab-tested, 100% legal. Visit our ${location} store to browse and purchase in person. Work time -12:00 - 22:00.`,
        h1,
        intro,
        bodyParagraphs,
  ...
  if (cat === "City") {
    ...
    if (city) {
      ...
      return {
        ...
        metaDescription: `Looking for CBD in ${city}? MCW CBD Relax Shop is ${city}'s #1 CBD destination. Shop oils, flowers, vapes, gummies, and more. Work time -12:00 - 22:00. Purchase in store.`,
        h1,
        intro,
        bodyParagraphs,
        schemaType: "LocalBusiness",
  ...
  if (cat === "Benefits") {
    ...
    return {
      ...
      metaDescription: `Discover how CBD can help with ${benefit.toLowerCase()}. Shop Malta's best CBD products at MCW — lab-tested, 100% legal, purchase in store at 4 Malta stores.`,
      h1,
      intro,
      bodyParagraphs,
      schemaType: "Article",
  ...
  if (cat === "Lifestyle") {
    ...
    metaDescription: `${label}: lifestyle guide from MCW, Malta's #1 CBD destination. Premium CBD products for a better lifestyle. Purchase in store at 4 Malta stores.`,
      h1,
      intro,
      bodyParagraphs,
      schemaType: "Article",
  ...
  if (cat === "About") {
    ...
    return {
      ...
      metaDescription: `${label}: learn more about MCW CBD Relax Shop, Malta's #1 hemp and CBD destination with 4 stores in Valletta, Sliema, Mellieha, and Bugibba.`,
      h1,
      intro,
      bodyParagraphs,
      schemaType: "Article",
  ...
  return {
    ...
    metaDescription: `${label}: expert CBD guide from MCW, Malta's #1 CBD shop. Shop premium CBD products and purchase in store at 4 Malta stores.`,
    h1,
    intro,
    bodyParagraphs,
    schemaType: "Article",
